...
class DesiredTrajectoryNode:
    ...
    def generate_trajectory(self):
        ...
        pf = 0*np.array([np.pi/2, np.pi/4, -np.pi/2])
        v0 = np.array([0, 0, 0]) 
        vf = np.array([0, 0, 0]) 
    ...
    def generate_torque(self):
        ...
        torque1 = (self.qddot1_desired + self.kp * e1  + self.ki * self.e1_sum + self.kv * edot1)
        torque2 = (self.qddot2_desired + self.kp * e2  + self.ki * self.e2_sum + self.kv * edot2)
        torque3 = (self.qddot3_desired + self.kp * e3  + self.ki * self.e3_sum + self.kv * edot3)
        pwm1 = (self.qddot1_desired + self.kp * e1  + self.ki * self.e1_sum + self.kv * edot1) * (885 / 4.1)
        pwm2 = (self.qddot2_desired + self.kp * e2  + self.ki * self.e2_sum + self.kv * edot2) * (885 / 4.1)
        pwm3 = (self.qddot3_desired + self.kp * e3  + self.ki * self.e3_sum + self.kv * edot3) * (885 / 4.1)
